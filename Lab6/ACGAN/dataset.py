...
def getData(mode, root, test_file='test.json'):
    ...
    if mode == 'train':
        ...
        filenames = list(data_json.keys()) # ['CLEVR_train_002066_0.png', 'CLEVR_train_002066_1.png', ...]
        labels_list = list(data_json.values()) # [['cyan cube'],  ['cyan cube', 'cyan sphere'], ...]
        one_hot_vector_list = []
        for i in range(len(labels_list)):
            one_hot_vector = np.zeros(24, dtype=np.int32)
