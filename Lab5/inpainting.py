...
#mask_b: iteration decoding initial mask, where mask_b is true means mask
    def inpainting(self,image,mask_b,i): #MakGIT inference       
        ...
        with torch.no_grad():
            ...
            vutils.save_image(dec_img_ori, os.path.join("result/cosine/9_8_2/pic", f"image_{i:03d}.png"), nrow=1) 

            #demo score 
            vutils.save_image(maska, os.path.join("result/cosine/9_8_2/mask", f"test_{i}.png"), nrow=10) 
            vutils.save_image(imga, os.path.join("result/cosine/9_8_2/imga", f"test_{i}.png"), nrow=7)
